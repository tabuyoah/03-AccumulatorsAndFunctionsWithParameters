...
#        necessary?  Why?
#            when you open a window, this is because if you do not have this command the window will close after the program ends
#
